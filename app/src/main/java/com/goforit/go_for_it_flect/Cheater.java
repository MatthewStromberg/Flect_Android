...
public class Cheater extends AppCompatActivity {
    ...
    public void lv_1_won()
    {
        ...
        replay_next.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                startActivity(new Intent(Cheater.this, LevelTwo.class));
                finish();
            }
        });
    }
    ...
    {
        startActivity(new Intent(Cheater.this, StartScreen.class));
        finish();
    }
}
